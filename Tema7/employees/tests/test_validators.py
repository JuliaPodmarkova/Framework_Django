...
class NeighborValidatorTest(TestCase):
    def setUp(self):
        ...
        self.dev_position = Position.objects.create(
            slug="backend-developer", name="Backend"
        )
    ...
    def test_cannot_place_dev_next_to_tester(self):
        ...
        dev_profile = EmployeeProfile(
            user=dev, position=self.dev_position, workplace=self.table1, gender="Male"
        )
