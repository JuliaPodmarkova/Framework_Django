...
class EmployeeProfile(models.Model):
    ...
    is_watcher = models.BooleanField(default=False, verbose_name="Смотритель")
    ...
    hire_date = models.DateField(
        verbose_name="Дата приёма на работу", default=timezone.now
    )
    ...
    def clean(self):
        ...
        neighbors = (
            EmployeeProfile.objects.filter(workplace__table_number__in=adjacent_tables)
            .exclude(pk=self.pk)
            .select_related("position", "workplace", "user")
        )
